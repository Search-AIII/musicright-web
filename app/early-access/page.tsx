    ...
    <div className="min-h-screen bg-[#080808] text-white">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 border-b border-white/5 bg-[#080808]/90 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/auth/login" className="text-[#555] text-sm hover:text-white transition-colors">
              Sign in
            </Link>
            <Link href="/auth/login" className="h-8 px-4 rounded-lg border border-[#2e2e2e] text-white text-xs font-semibold hover:border-[#00d4aa]/40 transition-colors">
              Create account
            </Link>
            <button onClick={handleCheckout} disabled={loading}
              className="h-8 px-4 rounded-lg bg-[#00d4aa] text-[#080808] text-xs font-bold hover:bg-[#00b894] transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-28 pb-24">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-24">
          ...
          <div>
            ...
            <h1 className="text-5xl md:text-6xl font-black tracking-tight leading-[1.05] mb-6">
              ...
              <span className="text-[#a0a0a0]">Start one song.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              ...
              <button onClick={handleCheckout} disabled={loading}
                className="h-12 px-8 rounded-xl bg-[#00d4aa] text-[#080808] font-bold text-sm flex items-center justify-center gap-2 hover:bg-[#00b894] transition-all glow disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-10">
              <Link href="/start"
                className="h-10 px-5 rounded-lg border border-[#1a1a1a] text-[#555] text-sm font-semibold flex items-center justify-center hover:text-white hover:border-[#2e2e2e] transition-colors">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={s.val} className="rounded-2xl border border-[#1a1a1a] bg-[#0e0e0e] p-4">
                  <div className="text-2xl font-black text-white mb-2">{s.val}</div>
                  <div className="text-[#555] text-[9px] font-bold uppercase tracking-[0.1em] leading-relaxed whitespace-pre-line">{s.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-[#1a1a1a] bg-[#0e0e0e] p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="text-[#555] text-[10px] font-bold uppercase tracking-[0.15em]">MUSICRIGHT GUIDED BRIEF</div>
              <span className="text-[10px] font-bold px-2 py-0.5 rounded-full border border-[#2e2e2e] text-[#555]">Guide</span>
            </div>

            {/* Inputs */}
            <div className="mb-6">
              <div className="text-[#555] text-[10px] font-bold uppercase tracking-[0.12em] mb-3">INPUTS</div>
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <div key={i.title} className="rounded-xl border border-[#1a1a1a] bg-[#111] p-4">
                    <div className="flex items-center gap-3">
                      <span className="text-lg">{i.icon}</span>
                      <div>
                        <div className="text-white text-sm font-semibold">{i.title}</div>
                        <div className="text-[#555] text-xs mt-0.5">{i.desc}</div>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="rounded-xl border border-[#00d4aa]/20 bg-[#00d4aa]/5 p-4 mb-4">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Your rights summary, simplified.</div>
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                <div key={s.n} className="flex items-start gap-3 p-3 rounded-xl border border-[#1a1a1a] bg-[#111]">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      <div className="text-white text-xs font-semibold">Guide step {s.n}</div>
            ...
            <div className="mt-4 rounded-xl border border-[#1a1a1a] bg-[#111] p-4">
              <div className="flex items-center justify-between mb-2">
                <div className="text-[#555] text-xs">Early Access readiness</div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start mb-24">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#1a1a1a] text-[#555] text-xs font-semibold mb-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            {ROUTING.map(r => (
              <div key={r.label} className="rounded-xl border border-[#1a1a1a] bg-[#0e0e0e] p-4">
                ...
                <div className="text-[#555] text-xs leading-relaxed">{r.desc}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-[#00d4aa]/20 bg-[#00d4aa]/5 p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            ...
            <h3 className="text-white font-black text-2xl mb-1">MusicRight.AI</h3>
            <p className="text-[#555] text-sm">Reserve your place in the first-user Creator Wallet list.</p>
          </div>
          <div className="flex gap-3 flex-shrink-0">
            <Link href="/auth/login"
              className="h-11 px-5 rounded-xl border border-[#2e2e2e] text-white font-semibold text-sm flex items-center hover:border-[#00d4aa]/40 transition-colors">
              Create account
            </Link>
            <button onClick={handleCheckout} disabled={loading}
              className="h-11 px-6 rounded-xl bg-[#00d4aa] text-[#080808] font-bold text-sm flex items-center gap-2 hover:bg-[#00b894] transition-all disabled:opacity-50 disabled:cursor-not-allowed">
              {loading ? "…" : "Place $5 Early Access →"}
            </button>
          </div>
        </div>
